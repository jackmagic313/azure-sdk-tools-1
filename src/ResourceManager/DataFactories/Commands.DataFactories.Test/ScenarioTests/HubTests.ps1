...
<#
.SYNOPSIS
Nagative test. Get resources with a hub name which only contains white space.
#>
function Test-GetHubWithWhiteSpaceName
{
    $dfname = Get-DataFactoryName
    $rgname = Get-ResourceGroupName
    $rglocation = Get-ProviderLocation ResourceManagement
    ...
    try
    {
        ...
        $actual = New-AzureDataFactoryHub -ResourceGroupName $rgname -DataFactoryName $dfname -Name $hubname -File .\Resources\hub.json -Force
        Assert-ThrowsContains { Get-AzureDataFactoryHub -ResourceGroupName $rgname -DataFactoryName $dfname -Name $hubname } "null"
...
<#
.SYNOPSIS
Nagative test. Get resources with an empty hub name.
#>
function Test-GetHubWithEmptyName
{
    $dfname = Get-DataFactoryName
    $rgname = Get-ResourceGroupName
    $rglocation = Get-ProviderLocation ResourceManagement
